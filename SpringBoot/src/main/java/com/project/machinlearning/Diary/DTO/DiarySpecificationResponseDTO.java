...
public class DiarySpecificationResponseDTO {
    ...
    public DiarySpecificationResponseDTO(Long numId, String nickName, Date writeDate, String content, String emotion, int view, String photo, int recommend, List<CommentResponseDTO> comments) {
        this.numId = numId;
